...
class scierc_aeco_DatasetJson(Dataset):
    def __init__(self, dataset_config, tokenizer, split_name, max_words=512):
        ...
        if split_name == "train":
            self.data = json.load(open(dataset_config.data_path+"/scierc_aeco_data_forllama_jsonscheme_train.json")) # self.data[0]["train"]  # Adjust this based on your dataset's structure
        else:
            self.data = json.load(open(dataset_config.data_path+"/scierc_aeco_data_forllama_jsonscheme_val.json"))# self.data[0]["validation"]  # Adjust this based on your dataset's structure
