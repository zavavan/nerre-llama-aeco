...
class dopingjson_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/doping/doping_data_forllama_json"
...
class dopingengextra_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/doping/doping_data_forllama_engextra"
...
class dopingeng_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/doping/doping_data_forllama_eng"
...
class generalmatfold0_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/generalmof/experiments_general/fold_0"
...
class generalmatfold1_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/generalmof/experiments_general/fold_1"
...
class generalmatfold2_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/generalmof/experiments_general/fold_2"
...
class generalmatfold3_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/generalmof/experiments_general/fold_3"
...
class generalmatfold4_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/generalmof/experiments_general/fold_4"
...
class moffold0_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/generalmof/experiments_mof/fold_0"
...
class moffold1_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/generalmof/experiments_mof/fold_1"
...
class moffold2_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/generalmof/experiments_mof/fold_2"
...
class moffold3_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/generalmof/experiments_mof/fold_3"
...
class moffold4_dataset:
    ...
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/generalmof/experiments_mof/fold_4"

@dataclass
class AuNR_dataset:
    dataset: str = "AuNR_dataset"
    train_split: str = "train"
    test_split: str = "val"
    data_path: str = "../datasets/AuNR/AuNR_data_forllama"
